...
public class Bootcamp {
	...
	@Override
	public int hashCode() {
		return Objects.hash(conteudos, dataFinal, dataInicial, destricao, devsInscritos, nome);
	}
	@Override
	public boolean equals(Object obj) {
		...
		return Objects.equals(conteudos, other.conteudos) && Objects.equals(dataFinal, other.dataFinal)
				&& Objects.equals(dataInicial, other.dataInicial) && Objects.equals(destricao, other.destricao)
